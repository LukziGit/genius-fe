...
let GenresService = class GenresService {
    ...
    create(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.genreRepository.save(genre);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    update(id, name) {
        return __awaiter(this, void 0, void 0, function* () {
            const genre = yield this.genreRepository.findOne({ where: { id: id } });
            genre.name = name;
...
exports.GenresService = GenresService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(genre_1.Genre)),
